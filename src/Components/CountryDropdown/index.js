        ...
        <>
            <Button className="countryDrop" onClick={()=>setisOpenModal(true)}>
                <div className='info d-flex flex-column'>
                    ...
                    <span className='name'>{context.selectedCountry !== "" ? (context.selectedCountry.length>12 ? context.selectedCountry.substring(0,12) + '..' : context.selectedCountry) : 'Select a location'}</span>
                </div>
